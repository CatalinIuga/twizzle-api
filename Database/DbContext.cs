...
{
    public TwizzleDbContext(DbContextOptions<TwizzleDbContext> options) : base(options) { }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Twizz -> QuotedTwizz relationship
        modelBuilder.Entity<Twizz>()
            .HasOne(t => t.QuotedTwizz)
            .WithMany()
            .HasForeignKey(t => t.QuotedTwizzId)
            .OnDelete(DeleteBehavior.Cascade);
